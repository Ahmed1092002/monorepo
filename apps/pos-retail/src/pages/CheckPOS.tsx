          ...
          >
            ...
            <div className="relative z-10">
              ...
              <Text variant="small" color="light" className="mt-4 opacity-95">
                Select your branch and POS, then set your starting cash to
                begin.
              </Text>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Text variant="small" color="secondary" className="mt-1">
                  {currentBranchOptions.length > 0
                    ? `${currentBranchOptions.length} branch${
                        currentBranchOptions.length === 1 ? "" : "es"
                      } available`
                    : "No branches cached for offline"}
                </Text>
              </div>
              ...
              <div>
                ...
                >
                  <option value="">
                    {selectedBranchValue ? "Select POS" : "Select Branch first"}
                  </option>
                ...
                <Text variant="small" color="secondary" className="mt-1">
                  {selectedBranchValue
                    ? `${currentPOSOptions.length} POS ${
                        currentPOSOptions.length === 1 ? "is" : "are"
                      } available`
                    : "Select a branch to load POS list"}
                </Text>
              </div>
            ...
            >
              Tip: Press Enter in "Start Cash" to continue quickly
            </Text>
          </div>
        </div>
      </div>
