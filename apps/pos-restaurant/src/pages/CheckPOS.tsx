  ...
  const handleLogOut = async () => {
    try {
      ...
      await db.clear().then(() => {
        ...
        logout({ redirectUri: import.meta.env.VITE_API_BASE_URL_RESTAURANT });
      });
    } catch (error) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Text variant="h3" color="light" weight="semibold">
                    Start your Restaurant POS session
                  </Text>
                </div>
              </div>
              <Text variant="small" color="light" className="mt-4 opacity-95">
                Select your restaurant branch and POS terminal, then set your
                starting cash to begin food service operations.
              </Text>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8">
            <div className="text-center mb-6">
              ...
              <Text variant="small" color="secondary" className="mt-1">
                Choose your restaurant location and terminal to start taking
                orders
              </Text>
            ...
            <div className="space-y-6">
              <div>
                ...
                <Text variant="small" color="secondary" className="mt-1">
                  {currentBranchOptions.length > 0
                    ? `${currentBranchOptions.length} restaurant location${
                        currentBranchOptions.length === 1 ? "" : "s"
                      } available`
                    : "No restaurant locations cached for offline"}
                </Text>
              </div>
              ...
              <div>
                ...
                >
                  <option value="">
                    {selectedBranchValue
                      ? "Select Order Terminal"
                      : "Select Restaurant Branch first"}
                  </option>
                ...
                <Text variant="small" color="secondary" className="mt-1">
                  {selectedBranchValue
                    ? `${currentPOSOptions.length} order terminal${
                        currentPOSOptions.length === 1 ? " is" : "s are"
                      } available`
                    : "Select a restaurant branch to load terminals"}
                </Text>
              </div>
              ...
              <div>
                ...
                />
                <Text variant="small" color="secondary" className="mt-1">
                  Required for cash transactions (can be 0)
                </Text>
              </div>
            ...
            >
              Tip: Press Enter in "Starting Cash Drawer" to begin service
              quickly
            </Text>
          </div>
        </div>
